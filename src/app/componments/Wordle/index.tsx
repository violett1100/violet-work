...
import { PopUp } from '@/app/componments/popUp'
import { LetterKey, SpecialKey } from './keyboard'
...
export function Wordle() {
  ...
  return (
    <>
      <div
        className={clsx(
          'fixed w-full h-screen flex justify-center items-center top-0 bg-gray-900/50',
          {
